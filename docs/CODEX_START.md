...
- production genplan totals after 2026-08-04 verification: 396 `urban_plan_layers`, 90 active `VERIFIED_STRICT/search` rows, 306 inactive/shadow rows. Active rows: `LPH` 3 rows, `LPH:household` 69 rows, `Gardening` 18 rows. Latest detailed status: `docs/GENPLAN_STATUS_2026_08_04.md`;
