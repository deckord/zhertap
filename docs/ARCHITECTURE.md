...
Production-снимок на 31.07.2026: 378 строк `urban_plan_layers`, из них 72
активных `VERIFIED_STRICT/search` и 306 неактивных `WARNING/shadow`.
Автоматическая strict-проверка для `ЛПХ:household` активна по 24
группам: регионально Акмолинская, Алматинская, Жетісу, ЗКО, Карагандинская,
Костанайская, Кызылординская, Мангистауская, Туркестанская и Улытауская
области; точечно Астана, Шымкент, Актобе, Атырау, Тараз, Павлодар,
Петропавловск, Шахтинск, Аркалык, Костанай, Лисаковск, Рудный, Тобыл и
Житикара. Shadow-слои
нельзя включать ручным изменением флагов БД; нужен новый
`VERIFIED_STRICT/search` release.
...
Подробный статус production-слоев генплана/ПДП: `docs/GENPLAN_STATUS_2026_08_04.md`.
...
Реализовано много функций мониторинга, но полная ретроспективная загрузка всех прошлых торгов E-Qazyna отдельным backfill-процессом еще не завершена. Текущая система накапливает историю с момента мониторинга и хранит изменения найденных лотов.
